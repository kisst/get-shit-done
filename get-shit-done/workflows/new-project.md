...
```bash
INIT=$(python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" init new-project)
```
...
```bash
mkdir -p .planning
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" commit "chore: add project config" --files .planning/config.json
```

**Persist auto-advance to config (survives context compaction):**

```bash
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" config-set workflow.auto_advance true
```
...
```bash
mkdir -p .planning
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" commit "docs: initialize project" --files .planning/PROJECT.md
```
...
```bash
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
