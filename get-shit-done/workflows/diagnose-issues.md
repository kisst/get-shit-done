...
```bash
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" commit "docs({phase_num}): add root causes from diagnosis" --files ".planning/phases/XX-name/{phase_num}-UAT.md"
```
</step>
