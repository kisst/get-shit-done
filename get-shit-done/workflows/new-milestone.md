...
```bash
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" commit "docs: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" init new-milestone)
```
...
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" config-set workflow.research true

# If "Skip research": persist false
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" config-set workflow.research false
```
...
**Commit requirements:**
```bash
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
