...
```bash
INIT=$(python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" init milestone-op)
```
...
```bash
integration_checker_model=$(python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" resolve-model gsd-integration-checker --raw)
```
...
python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" phases list
```
...
PHASE_INFO=$(python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" find-phase 01 --raw)
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" summary-extract "$summary" --fields requirements_completed | jq -r '.requirements_completed'
done
```
