...
```bash
INIT=$(python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" init progress)
```
...
- `STATE=$(python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(python3 "$HOME/.claude/get-shit-done/bin/gsd-tools.py" progress bar --raw)
```
